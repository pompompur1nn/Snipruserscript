    ...
    // @version      2.3
    // @description  jfriijosdfj ojfjadsiojisdofjffiojdsijfijsdfjsdfjisdfiojs
    // @author       pompompurin (pomsaddons.xyz)
    ...
    (function () {
        ...
        const getUserId = (name) =>
            fetch("https://www.roblox.com/users/profile?username=" + name).then((r) => {
                if (!r.ok) throw "either the roblox user api is down or you made a typo!!!!!!!!!!!!!!!!!!!!!";
        ...
        if (instancesContainer) {
            ...
            discordButton.innerText = "join discord please! (over 13 only)";
